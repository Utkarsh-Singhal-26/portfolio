                ...
                <section className="pb-10">
                    ...
                    <div className="max-w-4xl text-muted-foreground text-sm text-justify leading-relaxed">
                        <p className="mt-2 mb-4">
                            ...
                            scalable web applications. I thrive on solving
                            complex problems, optimizing performance, and
                            creating intuitive user experiences. My expertise
                            lies in Next.js, TypeScript, and Cloud technologies,
                            with a strong focus on delivering quality solutions.
                        </p>
                    </div>
                </section>
                        ...
                        return (
                            <React.Fragment key={key}>
                                <div className="items-start gap-12 grid lg:grid-cols-2 cursor-target">
                                    ...
                                    >
                                        <div>
                                            <h2 className="mb-1 font-medium text-2xl">
                                                {key}
                                            </h2>
                                ...
                                {index <
                                    Object.entries(projectsData).length - 1 && (
